...
class SettingsRepository:
    ...
    async def get_work_hours() -> Tuple[int, int]:
        ...
        """
        start = await SettingsRepository.get_setting("work_hours_start", str(WORK_HOURS_START))
        end = await SettingsRepository.get_setting("work_hours_end", str(WORK_HOURS_END))
    ...
    async def update_work_hours(start_hour: int, end_hour: int) -> bool:
        ...
        success_start = await SettingsRepository.set_setting("work_hours_start", str(start_hour))
        success_end = await SettingsRepository.set_setting("work_hours_end", str(end_hour))
