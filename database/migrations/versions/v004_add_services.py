...
class AddServicesBackwardCompatible(Migration):
    ...
    async def upgrade(self, db):
        ...
        await db.execute("CREATE INDEX IF NOT EXISTS idx_bookings_service ON bookings(service_id)")
    ...
    async def downgrade(self, db):
        ...
        try:
            ...
            await db.execute("CREATE UNIQUE INDEX idx_bookings_date_time ON bookings(date, time)")
